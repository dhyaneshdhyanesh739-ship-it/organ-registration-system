...
const LandingPage = () => {
    ...
    const fetchPublicData = async () => {
      try {
        const [statsRes, activityRes, demandRes] = await Promise.all([
          ...
          axios.get('http://localhost:5000/api/public/activity'),
          axios.get('http://localhost:5000/api/public/orders')
        ]);
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-pink-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
